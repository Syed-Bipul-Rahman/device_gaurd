...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateDetailedBatteryInfo(percentage: Int, status: Int, health: Int) {
        ...
        when (status) {
            BatteryManager.BATTERY_STATUS_CHARGING, BatteryManager.BATTERY_STATUS_FULL -> {
                binding.batteryStatus.setTextColor(ContextCompat.getColor(this, android.R.color.holo_green_dark))
            }
            else -> {
                binding.batteryStatus.setTextColor(ContextCompat.getColor(this, android.R.color.holo_orange_dark))
            }
        }
        ...
        when (health) {
            BatteryManager.BATTERY_HEALTH_GOOD -> {
                binding.batteryHealth.setTextColor(ContextCompat.getColor(this, android.R.color.holo_green_dark))
            }
            BatteryManager.BATTERY_HEALTH_COLD, BatteryManager.BATTERY_HEALTH_OVERHEAT -> {
                binding.batteryHealth.setTextColor(ContextCompat.getColor(this, android.R.color.holo_orange_dark))
            }
            else -> {
                binding.batteryHealth.setTextColor(ContextCompat.getColor(this, android.R.color.holo_red_dark))
            }
        }
    }
    ...
    private fun updateSimInfo() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE)
            ...
            // Operator
            val operatorName = telephonyManager.networkOperatorName?.takeIf { it.isNotEmpty() } ?: "No SIM"
            ...
            when (networkStatus) {
                "Connected" -> {
                    binding.networkStatus.setTextColor(ContextCompat.getColor(this, android.R.color.holo_green_dark))
                }
                else -> {
                    binding.networkStatus.setTextColor(ContextCompat.getColor(this, android.R.color.holo_red_dark))
                }
            }
        } else {
